...
/**
 * REST controller for managing {@link com.dxesoft.hestiatest.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
            ...
            .map(
                existingAddress -> {
                    ...
                    if (address.getSuite() != null) {
                        existingAddress.setSuite(address.getSuite());
                    }
                    if (address.getColonia() != null) {
                        existingAddress.setColonia(address.getColonia());
                    }
