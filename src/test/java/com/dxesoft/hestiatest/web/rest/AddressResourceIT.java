...
import com.dxesoft.hestiatest.domain.Address;
import com.dxesoft.hestiatest.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    private static final String DEFAULT_SUITE = "AAAAAAAAAA";
    private static final String UPDATED_SUITE = "BBBBBBBBBB";
    ...
    void createAddress() throws Exception {
        ...
        assertThat(testAddress.getSuite()).isEqualTo(DEFAULT_SUITE);
        assertThat(testAddress.getColonia()).isEqualTo(DEFAULT_COLONIA);
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].suite").value(hasItem(DEFAULT_SUITE)))
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.suite").value(DEFAULT_SUITE))
    ...
    void putNewAddress() throws Exception {
        ...
        assertThat(testAddress.getSuite()).isEqualTo(UPDATED_SUITE);
        assertThat(testAddress.getColonia()).isEqualTo(UPDATED_COLONIA);
